...
public class AesGCM: NSObject {
    ...
    public static func encrypt(
        ...
        do {
            ...
            return "\(Data(sealedBox.nonce).base64EncodedString()):\(combined.base64EncodedString())" as NSString
        } catch {
    ...
    public static func decrypt(
        ...
        guard let keyData = hexToBytes(keyBase64) else {
            return "Error in decryption"
        }
        let cipherData = ciphertextBase64.split(separator: ":")
        let ivData  = Data(base64Encoded: String(cipherData[0]))!
